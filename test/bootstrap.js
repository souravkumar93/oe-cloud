...
var createJWToken = function (user) {
    if (app.locals.enableJwt) {
        ...
        var opts = {
            'issuer': 'edgeverve.com',
            'audience': 'evfoundation.net',
            'algorithm': 'HS256'
        };
...
!fs.existsSync('client/bower_components/evf-designer') && fs.mkdirSync('client/bower_components/evf-designer');
!fs.existsSync('client/bower_components/evf-designer/templates') && fs.mkdirSync('client/bower_components/evf-designer/templates');
!fs.existsSync('client/bower_components/evf-designer/styles') && fs.mkdirSync('client/bower_components/evf-designer/styles');
!fs.existsSync('client/bower_components/evf-designer/index.html') && fs.writeFileSync('client/bower_components/evf-designer/index.html', '<html><body><div>EVF Page</div></body></html>', 'utf-8');
!fs.existsSync('client/bower_components/evf-designer/templates/default-form.html') && fs.writeFileSync('client/bower_components/evf-designer/templates/default-form.html', '<dom-module id="my-form"><style></style><template id="my-form"><div>EVF Form</div></template><script>Polymer({is:"my-form"});</script></dom-module>', 'utf-8');
!fs.existsSync('client/bower_components/evf-designer/templates/default-page.html') && fs.writeFileSync('client/bower_components/evf-designer/templates/default-page.html', '<html><body><div>EVF Page</div></body></html>', 'utf-8');
!fs.existsSync('client/bower_components/evf-designer/styles/default-theme.css') && fs.writeFileSync('client/bower_components/evf-designer/styles/default-theme.css', 'some css stuff', 'utf-8');
...
describe(chalk.blue('bootstrap test'), function () {
    ...
    it('waiting for boot scripts to finish', function (done) {
        createAdminUser(function () {
            createTestUser(defaultUser, 'ev-admin', function() {
