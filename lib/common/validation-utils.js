...
var getValidationError = require('./error-utils');
...
var applicableValidations = {
  ...
  'string': ['min', 'max', 'is', 'required', 'absence', 'in', 'notin', 'pattern', 'unique', 'enumtype', 'absencechar', 'refcodetype', 'script'],
...
var validationExpressionMapper = {
  ...
  'evValidation': validateEvValidation,
...
function validateMin(obj, cb) {
  log.info(obj.options, 'validateMin invoked  for : ', obj.inst.constructor.modelName, '->', obj.name);
  var err = null;
  if (blank(obj.data[obj.name])) {
    log.warn(obj.options, 'data for field ', obj.name, 'is not present');
    ...
    if ((obj.value !== null || typeof obj.value !== 'undefined') && attrValue < obj.value) {
      ...
      getValidationError(getErrorCode('min'), obj, function validateMinGetErrCb(error) {
        log.debug(obj.options, 'validateMin error :', JSON.stringify(error));
        err = error;
        cb(null, err);
      });
    } else {
      log.info(obj.options, 'validateMin rule passed for ', obj.inst.constructor.modelName, '->', obj.name);
      cb(null, err);
    }
  }
}
...
function validateMax(obj, cb) {
  log.info(obj.options, 'validateMax invoked  for : ', obj.inst.constructor.modelName, '->', obj.name);
  var err = null;
  if (blank(obj.data[obj.name])) {
    log.warn(obj.options, 'data for field ', obj.name, 'is not present');
    // value of the attribute/property which is undefined
    ...
    if ((obj.value !== null || typeof obj.value !== 'undefined') && attrValue > obj.value) {
      ...
      getValidationError(getErrorCode('max'), obj, function validateMaxGetErrCb(error) {
        log.debug(obj.options, 'validateMax error :', JSON.stringify(error));
        err = error;
        cb(null, err);
      });
    } else {
      log.info(obj.options, 'validateMax rule passed for ', obj.inst.constructor.modelName, '->', obj.name);
      cb(null, err);
    }
  }
}
...
function validateIs(obj, cb) {
  log.info(obj.options, 'validateIs invoked  for : ', obj.inst.constructor.modelName, '->', obj.name);
  var err = null;
  if (blank(obj.data[obj.name])) {
    log.warn(obj.options, 'data for field ', obj.name, 'is not present');
    // value of the attribute/property which is undefined
    ...
    if ((obj.value !== null || typeof obj.value !== 'undefined') && attrValue !== obj.value) {
      ...
      getValidationError(getErrorCode('is'), obj, function validateIsGetErrCb(error) {
        log.debug(obj.options, 'validateIs error :', JSON.stringify(error));
        err = error;
        cb(null, err);
      });
    } else {
      log.info(obj.options, 'validateIs rule passed for ', obj.inst.constructor.modelName, '->', obj.name);
      cb(null, err);
    }
  }
}
...
function validatePresence(obj, cb) {
  log.info(obj.options, 'validatePresence invoked  for : ', obj.inst.constructor.modelName, '->', obj.name);
  var err = null;
  ...
  if (blank(obj.data[obj.name])) {
    ...
    getValidationError(getErrorCode('presence'), obj, function validatePresenceGetErrCb(error) {
      log.debug(obj.options, 'validatePresence error :', JSON.stringify(error));
      err = error;
      cb(null, err);
    });
  } else {
    log.info(obj.options, 'validatePresence rule passed for ', obj.inst.constructor.modelName, '->', obj.name);
    cb(null, err);
  }
}
...
function validateAbsence(obj, cb) {
  log.info(obj.options, 'validateAbsence invoked  for : ', obj.inst.constructor.modelName, '->', obj.name);
  var err = null;
  ...
  if (!blank(obj.data[obj.name])) {
    ...
    getValidationError(getErrorCode('absence'), obj, function validateAbsenceGetErrCb(error) {
      log.debug(obj.options, 'validateAbsence error :', JSON.stringify(error));
      err = error;
      cb(null, err);
    });
  } else {
    log.info(obj.options, 'validateAbsence rule passed for ', obj.inst.constructor.modelName, '->', obj.name);
    cb(null, err);
  }
}
...
function absenceChar(obj, cb) {
  log.info(obj.options, 'absenceChar invoked  for : ', obj.inst.constructor.modelName, '->', obj.name);
  ...
  if (!blank(obj.data[obj.name])) {
    if (hasInvalidChars(obj.data[obj.name])) {
      ...
      getValidationError(getErrorCode('absencechar'), obj, function absenceCharGetErrCb(error) {
        log.debug(obj.options, 'absenceChar error :', JSON.stringify(error));
        err = error;
        cb(null, err);
      });
    } else {
      log.info(obj.options, 'absenceChar rule passed for ', obj.inst.constructor.modelName, '->', obj.name);
      cb(null, err);
    }
  } else {
    log.info(obj.options, 'absenceChar rule passed for ', obj.inst.constructor.modelName, '->', obj.name);
...
function validateIn(obj, cb) {
  log.info(obj.options, 'validateIn invoked  for : ', obj.inst.constructor.modelName, '->', obj.name);
  var err = null;
  if (blank(obj.data[obj.name])) {
    log.warn(obj.options, 'data for field ', obj.name, 'is not present');
    // value of the attribute/property which is undefined
    ...
    if (obj.value.indexOf(attrValue) < 0) {
      ...
      getValidationError(getErrorCode('in'), obj, function validateInGetErrCb(error) {
        log.debug(obj.options, 'validateIn error :', JSON.stringify(error));
        err = error;
        cb(null, err);
      });
    } else {
      log.info(obj.options, 'validateIn rule passed for ', obj.inst.constructor.modelName, '->', obj.name);
      cb(null, err);
    }
  }
}
...
function validateNotIn(obj, cb) {
  log.info(obj.options, 'validateNotIn invoked  for : ', obj.inst.constructor.modelName, '->', obj.name);
  var err = null;
  if (blank(obj.data[obj.name])) {
    log.warn(obj.options, 'data for field ', obj.name, 'is not present');
    // value of the attribute/property which is undefined
    ...
    if (obj.value.indexOf(attrValue) > -1) {
      ...
      getValidationError(getErrorCode('notin'), obj, function validateNotInGetErrCb(error) {
        log.debug(obj.options, 'validateNotIn error :', JSON.stringify(error));
        err = error;
        cb(null, err);
      });
    } else {
      log.info(obj.options, 'validateNotIn rule passed for ', obj.inst.constructor.modelName, '->', obj.name);
      cb(null, err);
    }
  }
}
...
function validateNumber(obj, cb) {
  log.info(obj.options, 'validateNumber invoked  for : ', obj.inst.constructor.modelName, '->', obj.name);
  var err = null;
  if (blank(obj.data[obj.name])) {
    log.warn(obj.options, 'data for field ', obj.name, 'is not present');
    // value of the attribute/property which is undefined
    ...
    if (typeof value !== 'number' || (typeof value === 'number' && isNaN(value))) {
      ...
      getValidationError(getErrorCode('number'), obj, function validateNumberGetErrCb(error) {
        log.debug(obj.options, 'validateNumber error :', JSON.stringify(error));
        err = error;
        cb(null, err);
      });
    } else {
      log.info(obj.options, 'validateNumber rule passed for ', obj.inst.constructor.modelName, '->', obj.name);
      cb(null, err);
    }
  }
}
...
function validateInteger(obj, cb) {
  log.info(obj.options, 'validateInteger invoked  for : ', obj.inst.constructor.modelName, '->', obj.name);
  var err = null;
  if (blank(obj.data[obj.name])) {
    log.warn(obj.options, 'data for field ', obj.name, 'is not present');
    // value of the attribute/property which is undefined
    ...
    if ((typeof value === 'number' && isNaN(value)) || value !== Math.round(value)) {
      ...
      getValidationError(getErrorCode('integer'), obj, function validateIntegerGetErrCb(error) {
        log.debug(obj.options, 'validateInteger error :', JSON.stringify(error));
        err = error;
        cb(null, err);
      });
    } else {
      log.info(obj.options, 'validateInteger rule passed for ', obj.inst.constructor.modelName, '->', obj.name);
      cb(null, err);
    }
  }
}
...
function validatePattern(obj, cb) {
  log.info(obj.options, 'validatePattern invoked  for : ', obj.inst.constructor.modelName, '->', obj.name);
  var err = null;
    ...
    if (value) {
      if (!value.match(obj.value)) {
        ...
        getValidationError(code, obj, function validatePatternGetErrCb(error) {
          log.debug(obj.options, 'validatePattern error :', JSON.stringify(error));
          err = error;
          cb(null, err);
        });
      } else {
        log.info(obj.options, 'validatePattern rule passed for ', obj.inst.constructor.modelName, '->', obj.name);
        cb(null, err);
      }
    } else {
      log.warn(obj.options, 'validatePattern rule violated for ', obj.inst.constructor.modelName, '->', obj.name);
...
function validateUniqueness(obj, cb) {
  log.info(obj.options, 'validateUniqueness invoked  for : ', obj.inst.constructor.modelName, '->', obj.name);
  var err = null;
  ...
  obj.inst.constructor.find(cond, obj.options, function validateUniquenessFindCb(error, found) {
    ...
    if (error) {
      getValidationError(code, obj, function validateUniquenessFindGetErrCb(error) {
        log.debug(obj.options, 'validateUniqueness error :', JSON.stringify(error));
        err = error;
        cb(null, err);
      });
      ...
      log.info(obj.options, 'validateUniqueness rule passed for ', obj.inst.constructor.modelName, '->', obj.name);
      cb(null, err);
    }
  }.bind(obj.inst));
}
...
/**
 *
 * get the appropriate function for evValidation depending on the type(type can be string, reference, function, etc.)
 * @param {String} type - type of evValidation
 * @returns {function} The matching evValidation function
 */
function validateEvValidation(type) {
  var evValidationfunc;
  switch (type) {
    case 'reference':
      evValidationfunc = validateReferenceData;
      break;
    case 'custom':
      evValidationfunc = validateExpression;
      break;
    default:
      evValidationfunc = null;
  }
  return evValidationfunc;
}
...
/**
 *
 *   validate evValidation rules written using expression language, it is used for custom type validations
 * @param {Object} obj - object containing validation rule details
 * @param {function} cb - callback function
 */
function validateExpression(obj, cb) {
  log.info(obj.options, 'validateExpression invoked  for : ', obj.inst.constructor.modelName, '->', obj.name);
  var rule = obj.value;
  ...
  exprLang.traverseAST(ast[rule.expression], obj.inst, obj.options).then(function validateExpressionCb(result) {
    ...
    if (result) {
      log.info(obj.options, 'validateExpression rule passed for ', obj.inst.constructor.modelName, '->', obj.name);
      cb(null, null);
    } else {
      log.warn(obj.options, 'validateExpression rule violated');
      getValidationError(getErrorCode('evValidation'), obj, function validateExpressionGetErrCb(error) {
        log.debug(obj.options, 'validateExpression error :', JSON.stringify(error));
        cb(null, error);
      });
    }
  });
...
/**
 *
 * validate evValidation rule if it is of type reference
 * @param {Object} obj - object containing validation rule details
 * @param {function} cb - callback function
 */
function validateReferenceData(obj, cb) {
  log.info(obj.options, 'validateReferenceData invoked  for : ', obj.inst.constructor.modelName, '->', obj.name);
  var rule = obj.value;
  ...
  try {
    var Model = loopback.getModel(refModel);
    async.map(refArray, function validateReferenceDataAsyncCb(reference, callback) {
      ...
      if (!errors || errors.length === 0) {
        log.info(obj.options, 'validateReferenceData rule passed for ', obj.inst.constructor.modelName, '->', obj.name);
        cb(null, null);
      } else {
        ...
        log.debug(obj.options, 'validateReferenceData error :', JSON.stringify(errors));
        cb(null, errors);
      }
    });
  } catch (e) {
...
/**
 *
 * inter model validation, query the refModel provided in the evValidation rule
...
function findRecord(Model, filter, obj, index, callback) {
  Model.find(filter, obj.options, function applyReferenceRuleFindCb(err, result) {
    ...
    if (!result || result.length === 0) {
      getValidationError(getErrorCode('evValidation'), obj, function applyReferenceRuleGetErrCb(error) {
        error.index = index;
        callback(null, error);
      });
    } else {
...
function validateBelongsTo(obj, cb) {
  log.info(obj.options, 'validateBelongsTo invoked  for : ', obj.inst.constructor.modelName);
  modelCheck(obj, function validateBelongsToCb(err, result) {
    if (err) {
      log.debug(obj.options, 'validateBelongsTo error :', JSON.stringify(err));
      cb(null, err);
    } else {
      ...
      var Model = loopback.getModelByType(modelTo);
          ...
          Model.find(filter, obj.options, function validateBelongsToFindCb(error, result) {
            ...
            if (obj.data[fk] && (!result || result.length === 0)) {
              ...
              getValidationError(getErrorCode('relation'), obj, function validateBelongsToGetErrCb(error) {
                log.debug(obj.options, 'validateBelongsTo error :', JSON.stringify(error));
                cb(null, error);
              });
            } else {
              log.info(obj.options, 'validateBelongsTo rule passed for ', obj.inst.constructor.modelName);
              cb(null, null);
            }
          });
          break;
...
function modelCheck(obj, callback) {
  ...
  var relationParams = obj.inst.constructor.settings.relations[obj.name];
  ...
  if (!(relation.modelTo instanceof Function) && !relation.keyTo && !relation.keyFrom) {
    relation = obj.inst.constructor.relations[obj.name];
    if (!relation) {
      ...
      if (obj.inst.constructor.settings.relations[obj.name].foreignKeyRequired) {
        fkCheck(obj, callback);
      } else {
        callback(null, obj);
      }
    }
  } else if (obj.inst.constructor.settings.relations[obj.name].foreignKeyRequired) {
    fkCheck(obj, callback);
  } else {
    callback(null, obj);
  }
...
function validateEnumtype(obj, cb) {
  log.info(obj.options, 'validateEnumtype invoked  for : ', obj.inst.constructor.modelName, '->', obj.name);
  var err = null;
  ...
  if (blank(obj.data[obj.name])) {
    ...
    var enumModel = loopback.findModel(obj.value);
    if (enumModel) {
      if (!enumModel.isValidEnum(obj.data[obj.name])) {
        ...
        getValidationError(code, obj, function validateEnumtypeGetErrCb(error) {
          log.debug(obj.options, 'validateEnumtype error :', JSON.stringify(error));
          err = error;
          cb(null, err);
        });
      } else {
        log.info(obj.options, 'validateEnumtype rule passed for ', obj.inst.constructor.modelName);
        cb(null, null);
      }
    } else {
      log.warn(obj.options, 'validateEnumtype rule violated');
...
function validateRefCode(obj, cb) {
  log.info(obj.options, 'validateRefCode invoked  for : ', obj.inst.constructor.modelName, '->', obj.name);
  var err = null;
  ...
  if (blank(obj.data[obj.name])) {
    ...
    var refCodeModel = loopback.findModel(obj.value);
    if (refCodeModel) {
      refCodeModel.count({
        code: obj.data[obj.name]
      }, obj.options, function validateRefCodeCb(err, count) {
        if (count > 0) {
          log.info(obj.options, 'validateRefCode rule passed for ', obj.inst.constructor.modelName);
          cb(null, null);
        } else {
          log.warn(obj.options, 'validateRefCode rule violated');
          getValidationError(code, obj, function validateRefCodeGetErrCb(error) {
            log.debug(obj.options, 'validateRefCode error :', JSON.stringify(error));
            err = error;
            cb(null, err);
          });
        }
...
function validateScriptInjection(obj, cb) {
  // log.info(obj.options, 'validateScriptInjection invoked  for : ', obj.inst.constructor.modelName, '->', obj.name);
  var fieldValue = obj.data[obj.name];

  if (fieldValue && fieldValue.toString().toLowerCase().indexOf('<script') !== -1) {
