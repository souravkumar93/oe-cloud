 ...
 */
/**
 * This test is for unit-testing the query result caching feature in the EVF framework.
 ...
 * the DB (bypassing the EVF framework, so that cache is not ecicted), fetching the 
