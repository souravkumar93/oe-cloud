 ...
 * 1. it will use two users. one is admin/admin and other is testuser/Infy123++
 ...
 * 7. Test case ensures that admin/admin cannot see testuser/Infy123++ 's flows.
...
describe(chalk.blue('Node-red test'), function () {
    ...
    before('Logint to EVF', function (done) {
        var options = {};
