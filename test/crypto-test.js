 ...
 */
/**
 * This test is for unit-testing the encryption feature in the EVF framework.
 ...
 * by directly accessing the DB (bypassing the EVF framework) as well as
 * using the EVF framework. For a successful test, the original property value
 * should not match the value retrieved by directly accessing the DB, but it
 * should match the value retrieved using the EVF framework.
 * 
